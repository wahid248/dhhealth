...
namespace Data.Migrations
{
    ...
    [Migration("20210119162119_Banner")]
            ...
            modelBuilder.Entity("Core.Entities.EmailTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "SYSTEM",
                            CreatedOn = new DateTime(2021, 1, 19, 16, 21, 19, 651, DateTimeKind.Utc).AddTicks(2262),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Core.Entities.Page", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ControllerName = "Home",
                            CreatedBy = "SYSTEM",
                            CreatedOn = new DateTime(2021, 1, 19, 16, 21, 19, 636, DateTimeKind.Utc).AddTicks(2447),
                            IsDeleted = false,
                            IsEnabled = true,
                            Name = "Home"
                        },
            ...
            modelBuilder.Entity("Core.Entities.Banner", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Page", "Page")
                        .WithOne("Banner")
                        .HasForeignKey("Core.Entities.Banner", "PageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
