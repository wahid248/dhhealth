...
namespace Data.Migrations
{
    ...
    [Migration("20210206080319_DropBannerTableAddNewsTable")]
    partial class DropBannerTableAddNewsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.EmailTemplate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "SYSTEM",
                            CreatedOn = new DateTime(2021, 2, 6, 8, 3, 19, 44, DateTimeKind.Utc).AddTicks(3759),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("Core.Entities.JobPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ApplyProcess")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Entities.News", b =>
                {
                    ...
                    b.Property<int?>("LargeImageId")
                        .HasColumnType("int");

                    b.Property<int?>("MediumImageId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Core.Entities.Page", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ControllerName = "Home",
                            CreatedBy = "SYSTEM",
                            CreatedOn = new DateTime(2021, 2, 6, 8, 3, 19, 0, DateTimeKind.Utc).AddTicks(2076),
                            IsDeleted = false,
                            IsEnabled = true,
                            Name = "Home"
                        },
            ...
            modelBuilder.Entity("Core.Entities.Page", b =>
                {
                    b.HasOne("Core.Entities.Image", "Banner")
                        .WithMany("PageBaners")
